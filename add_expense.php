...
// Check if the Add Expense button is clicked
if (isset($_POST['add'])) {
    ...
    header('location: add_expense.php?message=added');
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="manage_expense.php" class="list-group-item list-group-item-action sidebar-active"><span>&#8377;</span> Manage Expenses</a>
            </div>
        ...
        <div id="page-content-wrapper">
                    ...
                    <div class="col-md" style="margin:0 auto;">
                        <form action="" method="POST" id="expenseForm">
                            <div class="form-group row">
                                <label for="expenseamount" id=" expenseAmount" class="col-sm-6 col-form-label"><b>Enter Amount(₹)</b></label>
                                <div class="col-md-6">
                                    <input type="number" id="expenseAmount" class="form-control col-sm-12" value="<?php echo $expenseamount; ?>" id="expenseamount" name="expenseamount" required>
                                </div>
                            </div>
                            <div class="form-group row">
            ...
            <div class="col-md-12 text-right">
                <?php if ($update == true) : ?>
                    <button class="btn btn-lg btn-block btn-warning" style="border-radius: 0%;" type="submit" name="update" id="updateExpenseBtn">Update</button>
                <?php elseif ($del == true) : ?>
                    <button class="btn btn-lg btn-block btn-danger" style="border-radius: 0%;" type="submit" name="delete" id="deleteExpenseBtn">Delete</button>
                <?php else : ?>
                    <button id="addExpenseBtn" type="submit" name="add" class="btn btn-lg btn-block btn-success" style="border-radius: 0%;">Add Expense</button>
...
document.addEventListener("DOMContentLoaded", function() {
    document.getElementById("addExpenseBtn").addEventListener("click", function(event) {
        ...
        // Check if expense amount is entered
